...
values{1}  = zeros(60,1); % all species start at zero by default
values{2}  = {...
    ...
    'LPSo'     ,'TNFt'  , 'TNFin'   ,  'TNF'   ,'tnfrm' , ... % 41-45 NEW
    'TNFR'     ,'TNFRtnf', 'C1'     ,  'C1_off','C1tnf' , ... % 46-50 NEW
    'C1tnf_off','TTR'   , 'a20'     ,  'a20t'  ,'CpG'   , ... % 51-55 NEW
    'TLR9'     ,'CpGTLR9', 'PIC'    ,  'TLR3'  ,'PICTLR3',... % 56-60 NEW
    };
...
values{1}(28)   = .1;%0.1*100;    % IKKK_off
values{1}(30)   = .1;%0.1*100;    % IKK_off
values{1}(32)   = 0.1*100;   % TRAF_off
values{1}(35)   = 0.1*100;    % TBK1
values{1}(37)   = 0.1;      % IRF3
values{1}(52)   = 8.3e-4; % TTR
