...
mRNA_predict <- read.csv('./simData/mRNA_all2.csv',header=F,
                         col.names=c('Time_mins','wt','mko','tko'))
mRNA_predict_wt <- read.csv('./simData/mRNA_all_wt.csv',header=F,
                         col.names=c('Time_mins','wt','mko','tko'))
mRNA_predict_tko <- read.csv('./simData/mRNA_all_tko.csv',header=F,
                         col.names=c('Time_mins','wt','mko','tko'))
