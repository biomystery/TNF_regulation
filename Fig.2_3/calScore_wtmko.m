function residues = calScore_wtmko(input_pars,nascent_exp,expData,plot_flag)
...
[t,mko]= ode15s(@ode3,times,yinit(2),[],[],nascent_exp(:,[1 3]), ...
                       pars);
...
residues = residues(:);
%residues(end-1) = 2*residues(end-1);
