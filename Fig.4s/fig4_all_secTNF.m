...
for i =1:N % different pr vs same pr. 
    ...
    residues = calScoreb(input_pars,mRNA_exp,expData2,0);
...
subplot 122;calScoreb([degp_rate(i),sec_rate(j)],mRNA_exp,expData2,1);
...
print -dpdf -painters fig4s_all_secTNF.pdf
saveas(gca,'fig4s_all_secTNF.fig')
close all; !open fig4s_all_secTNF.pdf

save ./simData/fig4s_all_secTNF.mat 