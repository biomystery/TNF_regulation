...
csvwrite('./simData/proTNF_all_both.csv',[t proTNF_wt proTNF_mko proTNF_tko])
...
csvwrite('./simData/sec_all_both.csv',[t cumsum([TNF_wt*ksec TNF_mko*ksec TNF_tko*ksec/sec_regulator])])
