...
csvwrite('./simData/proTNF_all_tl.csv',[t proTNF_wt proTNF_mko proTNF_tko])
...
csvwrite('./simData/sec_all_tl.csv',[t cumsum([TNF_wt*k_secs(1) TNF_mko*k_secs(1) TNF_tko*k_secs(1)])]);
